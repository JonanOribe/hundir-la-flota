...
public class Main {
	 ...
	 * valor del menú al usuario. Si no se introduce un valor del menú marca
	 * error y vuelve a pedir hasta que se introduzca un valor correcto.
	 */
